...
MODEL_URL = "https://huggingface.co/nayif05/alexnet-malaria-detection/blob/main/alexnet.h5"
MODEL_PATH = os.path.join(os.path.dirname(__file__), "alexnet.h5")

# The correct way to download a model from Hugging Face
def download_model():
    try:
        MODEL_PATH = os.path.join(os.path.dirname(__file__), "alexnet.h5")
        ...
        if not os.path.exists(MODEL_PATH):
            ...
            # Method 1: Using the huggingface_hub library (recommended)
            try:
                MODEL_PATH = hf_hub_download(
                    repo_id="nayif05/alexnet-malaria-detection",
                    filename="alexnet.h5",
        ...
        print(f"Unexpected error in download_model: {e}")
        return False
